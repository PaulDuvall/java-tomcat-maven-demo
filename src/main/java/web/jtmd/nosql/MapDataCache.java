...
public class MapDataCache {
	...
	public static void putDataStampKey(String map, String key, String value) {
		...
		// Read more:
		// http://javarevisited.blogspot.com/2012/01/get-current-date-timestamps-java.html#ixzz3ZljoiTMx

		getInstance().getDb().getTreeMap(map)
				.put(key + " " + localDateFormat.format(new Date()), value);
		getInstance().getDb().commit();
	}
